...
class MovieModel {
  ...
  @override
  String toString() {
    return 'MovieModel(title: $title,title1:$time,name:$name,image:$image,namee:$namee,imagee:$imagee,trainNumber:$trainNumber, description: $description, actors: $actors, like: $like, bannerUrl: $bannerUrl, screens: $screens)';
  }
